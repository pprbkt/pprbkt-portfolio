...
export default function ProjectsPage() {
  ...
  useEffect(() => {
    try {
      let filtered = allProjects; // Start with all projects instead of getProjectsByCategory
      ...
      <section className="section-padding relative overflow-hidden pt-32">
        <div className="max-w-7xl mx-auto">
          <motion.div
            ...
            animate={inView ? scrollAnimations.blurIn.animate : scrollAnimations.blurIn.initial}
          ...
          >
            ...
            <p className="text-xl text-white max-w-3xl mx-auto leading-relaxed">
              {allProjects.length} things I built when I should have been studying. 
              Some are useful, others exist because I was bored. Sorted by recency.
            </p>
          </motion.div>
          ...
          <motion.div
            ...
            animate={inView ? scrollAnimations.fadeInUp.animate : scrollAnimations.fadeInUp.initial}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {displayedProjects.map((project, index) => (
                <motion.div
                  ...
                  className="bg-white/5 backdrop-blur-sm rounded-2xl overflow-hidden border border-white/10 hover:border-white/30 transition-all duration-300 group flex flex-col h-full"
                >
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div>
            ...
            <p className="text-xl text-white mb-6 leading-relaxed">
              I promise my next project won't be "yet another todo app." Unless that's exactly what you need.
            </p>
            <Link
              href="/contact"
